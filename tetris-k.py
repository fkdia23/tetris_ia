...
class Tetris:
    ...
    def clear_lines(self) -> None:
        ...
        if lines_cleared:
            ...
            self.score += lines_cleared * 200  # Augmenter le score de 200 points par ligne supprimée
            self.level = self.score // 200 + 1  # Augmenter le niveau chaque fois qu'on atteint un score de 200 points
    ...
    def run(self):
        ...
        while True:
            ...
            if fall_time >= fall_speed * 1000 and not self.paused and not self.game_over:
                ...
                # Ajuster la vitesse de chute en fonction du niveau
                fall_speed = 0.5 - (self.level - 1) * 0.05
                if fall_speed < 0.05:  # Limiter la vitesse minimale
                    fall_speed = 0.05
